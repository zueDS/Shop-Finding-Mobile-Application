                            ...
                            <div class="col-lg-12">
                                <div class="card">
                                    <div class="card-header">
                                        <h5 class="card-title mb-0">Active Products Added by Shops</h5>
                                    </div>
                                    <div class="card-body">
                                        <table id="scroll-vertical" class="table table-bordered dt-responsive nowrap align-middle mdl-data-table" style="width:100%">
                                            ...
                                            <tbody>
                                                ...
                                                $sqlzy34 = "SELECT * FROM productdetails where statusz='Active'";
            ...
            function DeleteUserRequest(vv) {
                ...
                function(data, status) {
                    ...
                    if (data == "ok") {
                        ...
                        window.location = "ViewRemoveProdcuAdmin.php";
