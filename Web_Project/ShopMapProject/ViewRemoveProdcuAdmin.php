...
<html lang="en" data-layout="vertical" data-topbar="light" data-sidebar="dark" data-sidebar-size="lg" data-sidebar-image="none" data-preloader="disable">
    ...
    <head>
        ...
        <meta charset="utf-8" />
        <title>View Product removed | Velzon </title>
    ...
    <body>
                            ...
                            <div class="col-lg-12">
                                <div class="card">
                                    <div class="card-header align-items-center d-flex">
                                        <h4 class="card-title mb-0 flex-grow-1">View Removed Products</h4>
                            ...
                            <div class="col-lg-12">
                                <div class="card">
                                    <div class="card-header">
                                        <h5 class="card-title mb-0">Removed Products of shops</h5>
                                    </div>
                                    <div class="card-body">
                                        <table id="scroll-vertical" class="table table-bordered dt-responsive nowrap align-middle mdl-data-table" style="width:100%">
                                            ...
                                            <tbody>
                                                ...
                                                $sqlzy34 = "SELECT * FROM productdetails where statusz='Removed'";
                                                ...
                                                foreach ($query4 as $value4) {
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><?php echo $value4['shopnamez']; ?></td>
                                                        ...
                                                        <td><button class="btn btn-success" onclick="DeleteUserRequest2(<?php echo $value4['id']; ?>)">Active</button></td>
                                                    </tr>
                                                    <?php
                                                }
                                                ?>
        ...
        <script>
            function DeleteUserRequest2(vv) {
                ...
                $.post("phpfiles/activeproseller.php",
                        {
                            userid: userid
                ...
                function(data, status) {
                    ...
                    if (data == "ok") {
                        ...
                        swal("Product Actived...!", {
                            icon: "success",
                        });
                        window.location = "ViewActiveProAdmin.php";
