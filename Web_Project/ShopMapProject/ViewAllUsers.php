...
<html lang="en" data-layout="vertical" data-topbar="light" data-sidebar="dark" data-sidebar-size="lg" data-sidebar-image="none" data-preloader="disable">
    ...
    <head>
        ...
        <meta charset="utf-8" />
        <title>View All Sellers | Velzon </title>
    ...
    <body>
                            ...
                            <div class="col-lg-12">
                                <div class="card">
                                    <div class="card-header align-items-center d-flex">
                                        <h4 class="card-title mb-0 flex-grow-1">View all Sellers</h4>
                            ...
                            <div class="col-lg-12">
                                <div class="card">
                                    <div class="card-header">
                                        <h5 class="card-title mb-0">Sellers Register in system</h5>
                                    </div>
                                    <div class="card-body">
                                        <table id="scroll-vertical" class="table table-bordered dt-responsive nowrap align-middle mdl-data-table" style="width:100%">
                                            ...
                                            <tbody>
                                                ...
                                                $sqlzy34 = "SELECT * FROM userdetails where shopname!='Admin'";
                                                ...
                                                foreach ($query4 as $value4) {
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><?php echo $value4['shopname']; ?></td>
                                                        <td><?php echo $value4['email']; ?></td>
                                                        <td><?php echo $value4['contatcatz']; ?></td>
                                                        <td><?php echo $value4['city']; ?></td>
                                                        <td><?php echo $value4['addressz']; ?></td>
                                                        <td><?php echo $value4['latitute']; ?></td>
                                                        <td><?php echo $value4['longtute']; ?></td>
                                                        <td><button class="btn btn-danger" onclick="DeleterSeller(<?php echo $value4['id']; ?>)">Remove</button></td>
                                                    </tr>
                                                    <?php
                                                }
                                                ?>
        ...
        <script>
            function DeleterSeller(vv) {
                ...
                $.post("phpfiles/removeseller.php",
                        {
                            userid: userid
