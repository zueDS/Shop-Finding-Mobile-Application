                                        ...
                                        <div class="col-xl-12">
                                            <div class="card">
                                                <div class="card-header align-items-center d-flex">
                                                    <h4 class="card-title mb-0 flex-grow-1">Recently added products by you</h4>
                                                    ...
                                                    <div class="table-responsive table-card">
                                                        <table class="table table-borderless table-centered align-middle table-nowrap mb-0">
                                                            ...
                                                            <tbody>
                                                                ...
                                                                $sqlzy34 = "SELECT * FROM productdetails where selleremailz='$emaillog'";
                                                                ...
                                                                foreach ($query4 as $value4) {
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <div class="d-flex align-items-center">
                                                                                <div class="flex-shrink-0 me-2">
                                                                                    <img src="<?php echo $value4['proimgurl']; ?>" alt="" class="avatar-xs rounded-circle" />
                                                                                </div>
                                                                                <div class="flex-grow-1"><?php echo $value4['pronamez']; ?></div>
                                                                            </div>
                                                                        </td>
                                                                        ...
                                                                        if ($stz == "Active") {
                                                                            ...
                                                                            ?>
                                                                            <td><span class="badge badge-soft-danger">Removed</span></td>
                                                                            <?php
                                                                        }
                                                                        ?>
