...
<html lang="en" data-layout="vertical" data-topbar="light" data-sidebar="dark" data-sidebar-size="lg" data-sidebar-image="none" data-preloader="disable">
    ...
    <head>
        ...
        <meta charset="utf-8" />
        <title>Add new Product | Velzon </title>
                                        ...
                                        <div class="col-12">
                                            <div class="d-flex align-items-lg-center flex-lg-row flex-column">
                                                <div class="flex-grow-1">
                                                    <h4 class="fs-16 mb-1">Add new products to shop</h4>
                            ...
                            <div class="col-lg-12">
                                <div class="card">
                                    <div class="card-header align-items-center d-flex">
                                        <h4 class="card-title mb-0 flex-grow-1">Details of product</h4>
                                        ...
                                        <div class="live-preview">
                                            <div class="row gy-4">
                                                ...
                                                <div class="col-xxl-6 col-md-6">
                                                    <div>
                                                        <label for="basiInput" class="form-label">Product description</label>
                                                        <input type="text" class="form-control" id="p3" name="p3">
                                                    </div>
                                                </div>
                                                <div class="col-xxl-6 col-md-6">
                                                    <div>
                                                        <label for="basiInput" class="form-label">Product Image URL</label>
                                                ...
                                                <center>
                                                    <input type="button" class="btn btn-info btn-lg" value="Add Product" onclick="AddnewProduct()"/>
                ...
                if (p1 == "" || p2 == "" || p3 == "" || p4 == "") {
                    ...
                    function(data, status) {
                        if (data == "ok") {
                            ...
                            swal("Done..!New Product Added Sucessfully...!", {
                                icon: "success",
                            });
